...
// CHANGE RESOURCE RECORD SETS
	...
	$change_batch = array(
		'Comment' => 'This change creates an MX record for example.com. (zone apex) with multiple ResourceRecord and Value.',
		'Changes' => array(
			array(
				'Action' => 'CREATE',
					...
					'ResourceRecords' => array(
						array(
							'ResourceRecord' => array(
								'Value' => '10 mx-1.domain.com.'
							)
						),
						array(
							'ResourceRecord' => array(
								'Value' => '20 mx-2.domain.com.'
							)
						),
						array(
							'ResourceRecord' => array(
								'Value' => '30 mx-3.domain.com.'
							)
						)
					)
				)
