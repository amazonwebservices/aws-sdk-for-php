...
/*
	...
	* Run this file from the command line with `php s3_mime_error.php`.
*/
...
// UPLOAD FILES TO S3
	...
	$bucket = 'temp-bucket-' . strtolower($s3->key) . '-' . time();
	...
	if ($create_bucket_response->isOK())
	{
		...
		*/
		...
		if ($file_upload_response->areOK())
		{
			...
			{
                // Display the file content types
                echo $filename . ' ';
				echo $s3->get_object_headers( $bucket, $filename )->header['content-type'];
